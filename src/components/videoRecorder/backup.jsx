  ...
  return (
    <div>
      <div>
        ...
        <select id="videoSource" name="videoSource" value={videoSource} onChange={(e) => setVideoSource(e.target.value)}>
          {videoSourceOptions.map((option) => (
            <option key={option.value} value={option.value}>
              {option.label}
            </option>
      ...
      <div>
        <select id="audioSource" name="audioSource" value={audioSource} onChange={(e) => setAudioSource(e.target.value)}>
